...
class MyProfile(models.Model):
    ...
    countries_visited = models.CharField(max_length=200, unique=True, blank=True, default='')  # Default value
    interests = models.CharField(max_length=200, unique=True, blank=True, default='')  # Default value
